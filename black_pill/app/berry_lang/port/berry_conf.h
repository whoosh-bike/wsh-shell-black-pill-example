 ...
 * Default: 0
 */
#define BE_NO_PRINTF_LONGLONG			1
 ...
 * They will not compile related modules when they are ffalse.
 **/
...
#define BE_EXPLICIT_MALLOC	be_malloc_impl
#define BE_EXPLICIT_FREE	be_free_impl
#define BE_EXPLICIT_REALLOC be_realloc_impl
